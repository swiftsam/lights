...
schedule_scene("midday",  "middle", paste0(Sys.Date(),"T09:00:00"), trans_time = 10*60*15)
schedule_scene("evening", "middle", paste0(Sys.Date(),"T16:00:00"), trans_time = 10*60*15)
schedule_scene("night",   "middle", paste0(Sys.Date(),"T18:00:00"), trans_time = 10*60*15)
